...
async function main() {
  ...
  const instructor = await prisma.user.create({
    data: {
      ...
      name: "Bob Instructor",
      password: hashPassword("instructor-pass"),
      bio: "Instructor",
    },
  });
  ...
  const applicant = await prisma.user.create({
    data: {
      ...
      password: hashPassword("applicant-pass"),
      bio: "Wants to teach",
    },
  });
  ...
  const learner1 = await prisma.user.create({
    data: {
      ...
      username: "learner1",
      name: "Learner One",
      password: hashPassword("learner1-pass"),
    },
  });
  ...
  const learner2 = await prisma.user.create({
    data: {
      ...
      username: "learner2",
      name: "Learner Two",
      password: hashPassword("learner2-pass"),
    },
  });
        ...
        create: [
          {
            ...
            content: "Tổng quan React",
            contentType: "article",
            position: 0,
          },
          {
            title: "Lesson 2: Component & Props",
  ...
  const mod2 = await prisma.module.create({
    data: {
      ...
      lessons: {
        create: [
          {
            title: "Lesson 1: useState",
            content: "Sử dụng useState",
            contentType: "article",
            position: 0,
          },
          {
            title: "Lesson 2: useEffect",
            content: "Sử dụng useEffect",
            contentType: "article",
            position: 1,
          },
        ],
  ...
  await prisma.review.create({
    data: { courseId: course.id, userId: learner1.id, rating: 5, comment: "Great course!" },
  });
  ...
  await prisma.certificate.create({
    data: {
      userId: learner1.id,
      courseId: course.id,
      certificateUrl: "https://certs.example.com/cert1",
      verificationCode: "CERT-0001",
    },
  });
  ...
  await prisma.notification.create({
    data: {
      ...
      channel: "IN_APP",
      title: "Welcome",
      body: "Chúc mừng bạn đã đăng ký khoá học",
  ...
  await prisma.auditLog.create({
    data: {
      ...
      resource: "InstructorApplication",
      resourceId: approvedApp.id,
      data: { note: "Demo approve" },
    },
  });
