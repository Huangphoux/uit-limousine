...
import { changeRoleUsecase, createCourseUsecase, getUsersUsecase, createUserByAdminUsecase, updateUserByAdminUsecase, deleteUserByAdminUsecase, approveCourseUseCase } from "../../composition-root.js";
...
router.get("/courses/", authenticationMiddleware, roleAuthorizationMiddleware(Role.ADMIN), getAllCoursesForAdmin);
router.post('/courses', authenticationMiddleware, roleAuthorizationMiddleware(Role.ADMIN), controller(createCourseUsecase))
router.patch('/courses/:id/update-publish-status',
...
router.delete('/courses/:id', authenticationMiddleware, roleAuthorizationMiddleware(Role.ADMIN), controller(createCourseUsecase))
