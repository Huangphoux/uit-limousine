...
export class NotificationRepository {
  async create(notificationData) {
    console.log('[NotificationRepository] Creating notification:', notificationData);
    ...
    try {
      ...
      console.log('[NotificationRepository] Notification created successfully:', notification.id);
  ...
  async findById(id) {
    console.log('[NotificationRepository] Finding notification by id:', id);
    ...
    try {
      ...
      if (!notification) {
        console.log('[NotificationRepository] Notification not found:', id);
        return null;
      }

      console.log('[NotificationRepository] Notification found:', notification.id);
      return new NotificationEntity(notification);
    } catch (error) {
      console.error('[NotificationRepository] Error finding notification:', error);
      throw error;
    }
  }

  async findByUserId(userId, filters = {}) {
    console.log('[NotificationRepository] Finding notifications for user:', userId, filters);
    ...
    try {
      ...
      console.log('[NotificationRepository] Found notifications:', notifications.length);
  ...
  async markAsRead(id) {
    console.log('[NotificationRepository] Marking notification as read:', id);
    ...
    try {
      ...
      console.log('[NotificationRepository] Notification marked as read:', notification.id);
      return new NotificationEntity(notification);
    } catch (error) {
  ...
  async markAllAsRead(userId) {
    ...
    try {
      ...
      console.log('[NotificationRepository] Marked as read count:', result.count);
      return result.count;
    } catch (error) {
